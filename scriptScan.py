...
steps=[50,34,11,0,199,180,123,119,95,64,62]
SeekLength=(50-34)+(34-11)+(11-0)+(199-0)+(199-180)+(180-123)+(123-119)+(119-95)+(95-64)+(64-62)#386
...
draw.text((width/2-300,10),font=font,text="Scan (down)",fill=(0,255,0))
